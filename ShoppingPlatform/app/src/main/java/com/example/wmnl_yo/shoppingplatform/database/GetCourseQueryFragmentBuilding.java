...
public class GetCourseQueryFragmentBuilding extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getCourseQueryFragmentBuilding...");
        String url = Constants.SERVER_URL + "getCourseQueryFragmentBuilding.php";
            ...
            if (statusCode == 200) {/*success*/
                ...
                if (inputStream == null) {
                    ...
                    if (buffer.length() == 0) {
                        ...
                        CourseQueryFragment.Building_check = "crycry";
                        Log.d("55125", "nothing");
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            ...
            for (int t = 0 ; t < nonDuplicateBuildingArray.length ; t++){
                if(nonDuplicateBuildingArray[t] == "不限")
                {
                    nonDuplicateBuildingArray[t] = nonDuplicateBuildingArray[0];
                    nonDuplicateBuildingArray[0] = "不限";
                }
            }

            CourseQueryFragment.stringBuilding = nonDuplicateBuildingArray;
        }
    }
}
