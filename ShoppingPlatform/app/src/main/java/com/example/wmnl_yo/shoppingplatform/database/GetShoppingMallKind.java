...
public class GetShoppingMallKind extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppingMallKind...");
        String url = Constants.SERVER_URL + "getShoppingMallKind.php";
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            ...
            ShoppingObjectFragment.string_shopping_object_kind = nonDuplicateBuildingArray;
        }
    }
}
