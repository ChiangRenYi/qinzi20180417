 ...
 * {@link SelectStudentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SelectStudentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SelectStudentFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sAdapter = new MySelectAdapter(SelectStudentObject.ITEMS);
...
//                    + " must implement OnFragmentInteractionListener");
    ...
    public class MySelectAdapter extends RecyclerView.Adapter<MySelectAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public SelectStudentObject.SelectStudentObjectItem mItem;
        ...
        public MySelectAdapter(List<SelectStudentObject.SelectStudentObjectItem> selectstudentList) {
            mselectstudentList = selectstudentList;
        }
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            holder.ivPic.setImageResource(mselectstudentList.get(position).pic);
            holder.tvName.setText(mselectstudentList.get(position).name);
        }

        @Override
        public int getItemCount() {
            return mselectstudentList.size();
        }
    }
