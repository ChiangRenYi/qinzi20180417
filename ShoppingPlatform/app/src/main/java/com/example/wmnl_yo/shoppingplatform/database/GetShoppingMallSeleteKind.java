...
public class GetShoppingMallSeleteKind extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppingMallSeleteKind...");
        String url = Constants.SERVER_URL + "getShoppingMallSeleteKind.php";
        ...
        try {
            ...
            //傳值
            Uri.Builder builder = new Uri.Builder().appendQueryParameter("kind", ShoppingObjectFragment.db_shopping_object_kind.trim());
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null) {
            ...
            String[] shoppingMallAll_introduction = new String[shoppingMallAll.length - 1];
            ShoppingMallObject.ITEMS.clear();
            ...
            for (int i = 0; i < shoppingMallAll.length - 1; i++) {
                ...
                shoppingMallAll_introduction[j] = shoppingMallAllInf[7];
