...
public class GetShoppingMallAll extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppingMallAll...");
        String url = Constants.SERVER_URL + "getShoppingMallAll.php";
        ...
        try {
            ...
            //傳值
            Uri.Builder builder = new Uri.Builder().appendQueryParameter("account",Constants.ACCOUNT.trim());
            Log.d("55125","ShoppingMallAll");
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null) {
            ...
            for (int i = 0; i < shoppingMallAll.length - 1; i++) {
                ...
                shoppingMallAll_introduction[j] = shoppingMallAllInf[8];
