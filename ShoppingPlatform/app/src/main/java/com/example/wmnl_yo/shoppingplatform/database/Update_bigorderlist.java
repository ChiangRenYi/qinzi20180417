...
public class Update_bigorderlist extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "Update_bigorderlist...");
        String url = Constants.SERVER_URL + "update_bigorderlist.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("bod_Odate", ShoppingPaymentFragment.codedate_str_8)
                    .appendQueryParameter("bod_OSMoney", String.valueOf(ShoppingPaymentFragment.priceTotal_all))
                    .appendQueryParameter("bod_Payment", ShoppingPaymentFragment.bod_payment)
                    .appendQueryParameter("bod_Code1", ShoppingPaymentFragment.code_1)
                    .appendQueryParameter("bod_Code2", ShoppingPaymentFragment.code_2)
                    .appendQueryParameter("bod_Code3", ShoppingPaymentFragment.code_3)
                    .appendQueryParameter("bod_Remark", "0");
