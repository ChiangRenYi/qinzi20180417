...
public class DeleteAbsentNoteStudent extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "deleteAbsentNoteStudent...");
        String url = Constants.SERVER_URL + "deleteAbsentNoteStudent.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("sl_id", AbsentNoteRecordDetailFragment.deleteSLid);
            ...
            AbsentNoteRecordDetailFragment.deleteSLcheck = result.trim();
            return result;
