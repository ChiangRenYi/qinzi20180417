...
public class GetAbsentNoteEntryFragmentTeacherMan extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getAbsentNoteEntryFragmentTeacher_man...");
        String url = Constants.SERVER_URL + "getAbsentNoteEntryFragmentTeacher_man.php";
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            ...
            postInf[0] = "請選擇";
            AbsentNoteEntryFragmentTeacher.string_absent_entry_teacher_man = postInf;
        }
    }
}
