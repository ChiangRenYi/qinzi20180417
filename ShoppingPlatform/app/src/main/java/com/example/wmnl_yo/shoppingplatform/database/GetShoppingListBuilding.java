...
public class GetShoppingListBuilding extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppinglistobjectbuilding...");
        String url = Constants.SERVER_URL + "getShoppinglistobjectbuilding.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("building", ShoppingListFragment.db_shoppinglist_kind.trim());
