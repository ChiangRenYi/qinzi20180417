 ...
 */
public class BuildingDetailFragment extends Fragment implements View.OnTouchListener {
    ...
    public static MyBuildAdapter buildadapter;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof BuildingDetailFragment.OnFragmentInteractionListener) {
            mListener = (BuildingDetailFragment.OnFragmentInteractionListener) context;
        } else {
