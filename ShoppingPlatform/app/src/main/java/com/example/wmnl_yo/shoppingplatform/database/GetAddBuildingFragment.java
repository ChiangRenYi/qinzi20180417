...
public class GetAddBuildingFragment extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getAddBuildingFragment...");
        String url = Constants.SERVER_URL + "getAddBuildingFragment.php";
