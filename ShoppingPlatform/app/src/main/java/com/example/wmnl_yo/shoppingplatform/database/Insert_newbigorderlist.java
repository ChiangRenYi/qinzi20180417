...
public class Insert_newbigorderlist extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "insert_newbigorderlist...");
        String url = Constants.SERVER_URL + "insert_bigorderlist.php";
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            Log.d("55125", s);
            ShoppingPaymentFragment.bigorderlistnumber = s.trim();
