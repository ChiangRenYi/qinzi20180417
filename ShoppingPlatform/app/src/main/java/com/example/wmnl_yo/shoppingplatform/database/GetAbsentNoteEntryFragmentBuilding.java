...
public class GetAbsentNoteEntryFragmentBuilding extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getAbsentNoteEntryFragment_building...");
        String url = Constants.SERVER_URL + "getAbsentNoteEntryFragment_building.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    Log.d("55125",AbsentNoteEntryFragment.db_absent_entry_student.trim()+Constants.ACCOUNT);
