...
public class DeleteShoppingListObject extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "deleteShoppinglistobject...");
        String url = Constants.SERVER_URL + "deleteShoppinglistobject.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("object",ShoppingListFragment.deleteitem);
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null) {
            Log.d("55125",s);
            ShoppingListFragment.deleteitemcheck = s.trim();
