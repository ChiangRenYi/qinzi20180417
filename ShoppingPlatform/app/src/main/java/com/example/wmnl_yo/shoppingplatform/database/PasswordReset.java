...
import com.example.wmnl_yo.shoppingplatform.fragment.PasswordResetFragment;
...
/**
 * Created by WMNL-Jimmy on 2017/9/26.
 */

public class PasswordReset extends AsyncTask<String,Void,String>{
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "PasswordReset...");
        String url = Constants.SERVER_URL + "PasswordReset.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("PasswordReset", PasswordResetFragment.PasswordChange);
