...
public class GetShoppingMallSeleteKindsecond extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppingMallSeleteKindsecond...");
        String url = Constants.SERVER_URL + "getShoppingMallSeleteKindsecond.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder().appendQueryParameter("kind", ShoppingObjectFragment.db_shopping_object_kind.trim())
                                                    .appendQueryParameter("kindsecond", ShoppingObjectFragment.db_shopping_object_kindsecond.trim());
