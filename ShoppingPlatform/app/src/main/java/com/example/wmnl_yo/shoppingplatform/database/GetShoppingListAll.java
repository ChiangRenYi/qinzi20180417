...
public class GetShoppingListAll extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getShoppinglistobjectall...");
        String url = Constants.SERVER_URL + "getShoppinglistobjectall.php";
